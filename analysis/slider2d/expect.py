...
def expect_score(
    *,
    ...
    leftover neu_hold, and unused off-caption slack. Those leftovers
    cannot flip a gate miss (0.15) or a 0.05 bottleneck gap; they only
    stop two HITs from printing the same 1.000.
    """
    ...
    tie = 0.50 * leftover_cover + 0.30 * leftover_hold + 0.20 * off_slack
...
def expect_values_are_unique(ranked: list[dict], *, places: int = 6) -> bool:
